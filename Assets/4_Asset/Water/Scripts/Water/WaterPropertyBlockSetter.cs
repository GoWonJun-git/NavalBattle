namespace Assets.Scripts.Water
{
    ...
    {
        [SerializeField] public List<Renderer> waterRenderers = new List<Renderer>();
        ...
        private MaterialPropertyBlock playerDieMaterial;

        private MaterialPropertyBlock materialPropertyBlock;

        public MaterialPropertyBlock MaterialPropertyBlock { get { return materialPropertyBlock; } }
